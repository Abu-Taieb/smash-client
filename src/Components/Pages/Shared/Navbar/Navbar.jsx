  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
        ...
        <li><NavLink className='p-3' to={'instructor'}>Instructors</NavLink></li>
        <li><NavLink className='p-3' to={'classes'}>Classes</NavLink></li>
        <li><NavLink className='p-3' to={'dashboard'}>Dashboard</NavLink></li>
      </ul>
    </div>
