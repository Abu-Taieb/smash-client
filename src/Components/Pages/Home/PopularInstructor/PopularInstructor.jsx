    ...
    return (
        <div className="w-full mx-auto justify-center p-10 ">
            <div className="text-center md:w-7/12 mx-auto">
                <h5 className="font-bold text-lg uppercase mb-2">Our Popular Instructors</h5>
                <hr className="w-20 mx-auto border-2 border-red-600" />
                <h2 className="font-bold text-4xl uppercase my-6">CHOOSE YOUR FAVORITE Instructor</h2>
