...
const Tournaments = () => {
    return (
        <div className="w-full mx-auto justify-center px-10 pb-10 mb-10">
        ...
        <div className="flex-row-reverse lg:flex mt-10 pt-5 px-0 lg:px-10 gap-12 items-center">
            
            <div className="w-full lg:w-2/3 bg-red-50 p-10">
